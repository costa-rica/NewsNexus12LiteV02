...
- [ ] Implement `src/app/layout.tsx` (root layout): render the `html`/`body` structure,
...
- [ ] Implement `src/app/page.tsx` (the single demo page): render `SlideStage` **once**,
...
- [ ] Add a test asserting the page renders **exactly one** `TopBar` and that the top bar,
...
- [ ] Confirm the top bar appears **once** and that the top bar, flow indicator, and table
